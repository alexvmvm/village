...
//             foreach(var thing in game.Things.Where(t => t.Config.TypeOfThing == TypeOfThing.Chick || t.Config.TypeOfThing == TypeOfThing.Hen || t.Config.TypeOfThing == TypeOfThing.Villager).ToArray())
//                 thing.Destroy();

//             for(var x = 0; x < game._size.x; x++)
//             {
//                 for(var y = 0; y < game._size.y; y++)
//                 {
